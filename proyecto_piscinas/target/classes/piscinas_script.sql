...
DROP DATABASE IF EXISTS gestion_piscinas;
DROP USER IF EXISTS usuario;
CREATE DATABASE gestion_piscinas;
USE gestion_piscinas;

create user 'usuario'@'%' identified by 'contrasenna';

grant all privileges on gestion_piscinas.* to 'usuario'@'%';
